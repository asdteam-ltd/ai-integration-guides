...
### 2.1 Заборона зміни архітектури
...
### 2.2 Дотримання стилю та шаблонів
...
### 2.3 Мінімізація зовнішніх залежностей
...
### 2.4 Обовʼязкове логування критичних точок
...
### 3.3 Обробка чутливої інформації
...
### 3.4 Поведінка при помилках та нестандартних ситуаціях
...
### 4.1 Статичний аналіз коду (SAST)
...
### 4.2 Аналіз залежностей (Dependency Scanning)
...
### 4.4 Перевірка секретів і токенів
...
### 5.1 Юніт- та інтеграційне тестування
...
### 5.2 Перевірка критичних сценаріїв вручну
...
### 5.3 Поведінкове тестування AI-коду
...
### 5.4 Тестування на середовищах (staging/dev)
...
### 5.6 Автоматизоване сповіщення та логування
...
### 6.1 Аутентифікація та авторизація
...
### 6.3 Збереження та передача чутливої інформації
...
### 6.4 Зовнішні інтеграції та API
...
### 6.7 Надійність AI-згенерованого коду
